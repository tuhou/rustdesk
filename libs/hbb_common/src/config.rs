...
pub const RENDEZVOUS_SERVERS: &[&str] = &["113.133.183.165"];
pub const PUBLIC_RS_PUB_KEY: &str = "Dy9EJsYNVOOV4vh6dE+XWwLr2uMjSwK4onk3dlDyoPk=";
...
pub const RENDEZVOUS_PORT: i32 = 16116;
pub const RELAY_PORT: i32 = 16117;
